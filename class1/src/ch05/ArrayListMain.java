...
public class ArrayListMain {
	...
	public static void main(String[] args) {
		...
		// 값 추가 방법
		list.add(3); // 인덱스 0번 - 값 : 3
		list.add(null); // 인덱스 1번 - 값 : null
		list.add(100); // 인덱스 2번 - 값 : 100
		// 3, null, 100
		list.add(1, 20); // (index번호, 값 할당) 인덱스번호 1번에 값 20을 넣어라
		// 3, 20, null, 100
		...
		// 3, 20, 100 <---- 70이란 값이 있는지 없는지
		// -70 --> int --> 자동으로 형 변환 클래스 타입으로 integer
