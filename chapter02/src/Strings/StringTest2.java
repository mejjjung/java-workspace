...
public class StringTest2 {
	...
	public static void main(String[] args) {
		...
		String str3 = new String("반가워"); // Q1 > 질문 str2와 str3은 주소값이 같을 까요?
		String str4 = "반가워"; // Q1 >str1과 str4는 주소값이 같을까요?
		...
		// 상수 풀에 한번 생성된 문자열은 불변(immutable이다.
		str4 = str4 + " 홍길동";
		System.out.println(System.identityHashCode(str4));
		str1 += " : 하이";
		System.out.println(System.identityHashCode(str1));
		...
		// 가 , 나 , a , 가 , 다 ,  마 <------- 계속 상수 풀 영역에 메모리를 사용한다.
		// 그래서 메모리를 효율적으로 사용하기 위해서는 
		// StringBuilder 클래스와, StringBuffer 라는 클래스를 알아야 한다.
	}
